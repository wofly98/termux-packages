...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="/data/data/com.xpmall/files/usr/glibc"
export CGCT_DIR="/data/data/com.xpmall/cgct"
...
TERMUX_REPO_PACKAGE="com.xpmall"
